...
%FINRATIO_ind  (BEGDATE=&uni_begdt, ENDDATE=&uni_enddt, NIND=25, AVR=mean, Input=firm_output_ME, IndRatios=ind_output_ff25);
proc export data=ind_output_ff25 outfile="/scratch/cityuhk/xinhe_mandy/sortport/ind_output_sort10_ME.csv" dbms=csv replace; run;
...
%FINRATIO_ind  (BEGDATE=&uni_begdt, ENDDATE=&uni_enddt, NIND=25, AVR=mean, Input=firm_output_BETA, IndRatios=ind_output_ff25);
proc export data=ind_output_ff25 outfile="/scratch/cityuhk/xinhe_mandy/sortport/ind_output_sort10_BETA.csv" dbms=csv replace; run;
...
%FINRATIO_ind  (BEGDATE=&uni_begdt, ENDDATE=&uni_enddt, NIND=25, AVR=mean, Input=firm_output_SVAR, IndRatios=ind_output_ff25);
proc export data=ind_output_ff25 outfile="/scratch/cityuhk/xinhe_mandy/sortport/ind_output_sort10_SVAR.csv" dbms=csv replace; run;
