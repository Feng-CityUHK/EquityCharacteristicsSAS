...
%MACRO DIVIDE_PORTFOLIO_6_SIZE_BM (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 if 0 <= me <= SIZEMEDN then        sizeport = 'ME1' ;
 else if me  > SIZEMEDN then        sizeport = 'ME2' ;
 else sizeport='';
 if 0 < beme <= beme30 then           btmport = 'BM1' ;
 else if beme30 < beme <= beme70 then btmport = 'BM2' ;
 else if beme  > beme70 then          btmport = 'BM3' ;
 else btmport='';
end;
else positivebeme=0;
...
proc export data=vwret2 outfile="vwret2_6_BM.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_BM;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_INV (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME INV pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if              inv <= inv30 then invport = 'INV1' ;
 else if inv30 < inv <= inv70 then invport = 'INV2' ;
 else if         inv  > inv70 then invport = 'INV3' ;
 else invport='';
end;
else positivebeme=0;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_INV;

%MACRO DIVIDE_PORTFOLIO_6_SIZE_OP (begdate=, enddate=, table_out=);
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME OP pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if             op <= op30 then opport = 'OP1' ;
 else if op30 < op <= op70 then opport = 'OP2' ;
 else if        op  > op70 then opport = 'OP3' ;
 else opport='';
end;
else positivebeme=0;
...
proc export data=vwret2 outfile="vwret2_6_OP.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_OP;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_MOM1M (begdate=, enddate=, table_out=);
...
proc univariate data=ccm_month noprint;
  ...
  var ME BEME mom1m;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME mom1m pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  mom1m <= mom1m30 then           momport = 'MOM1M1' ;
 else if mom1m30 < mom1m <= mom1m70 then momport = 'MOM1M2' ;
 else if mom1m  > mom1m70 then          momport = 'MOM1M3' ;
 else momport='';
 end;
 else positiveme = 0;
...
proc export data=vwret2 outfile="vwret2_6_MOM1M.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_MOM1M;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_MOM12M (begdate=, enddate=, table_out=);
...
proc univariate data=ccm_month noprint;
  ...
  var ME BEME mom12m;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME mom12m pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  mom12m <= mom12m30 then           momport = 'MOM12M1' ;
 else if mom12m30 < mom12m <= mom12m70 then momport = 'MOM12M2' ;
 else if mom12m  > mom12m70 then          momport = 'MOM12M3' ;
 else momport='';
 end;
 else positiveme = 0;
if cmiss(sizeport, momport)=0 then nonmissport=1; else nonmissport=0;
...
proc export data=vwret2 outfile="vwret2_6_MOM12M.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_MOM12M;

%MACRO DIVIDE_PORTFOLIO_6_SIZE_MOM60M (begdate=, enddate=, table_out=);
...
proc univariate data=ccm_month noprint;
  ...
  var ME BEME mom60m;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME mom60m pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  mom60m <= mom60m30 then           momport = 'MOM60M1' ;
 else if mom60m30 < mom60m <= mom60m70 then momport = 'MOM60M2' ;
 else if mom60m  > mom60m70 then          momport = 'MOM60M3' ;
 else momport='';
 end;
 else positiveme=0;
if cmiss(sizeport, momport)=0 then nonmissport=1; else nonmissport=0;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_MOM60M;

/* ********************************************************************************* */
/* MACRO's for acc cfp ep ni rvar svar beta dy             */

%MACRO DIVIDE_PORTFOLIO_6_SIZE_ACC (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME ACC pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if acc <= acc30 then           accport = 'ACC1' ;
 else if acc30 < acc <= acc70 then accport = 'ACC2' ;
 else if acc  > acc70 then          accport = 'ACC3' ;
 else accport='';
end;
else positivebeme=0;
...
proc export data=vwret outfile="vwret_6_ACC.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_ACC.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_ACC;



%MACRO DIVIDE_PORTFOLIO_6_SIZE_CFP (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME CFP pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if             cfp <= cfp30 then cfpport = 'CFP1' ;
 else if cfp30 < cfp <= cfp70 then cfpport = 'CFP2' ;
 else if        cfp  > cfp70 then cfpport = 'CFP3' ;
 else cfpport='';
end;
else positivebeme=0;
...
proc export data=vwret2 outfile="vwret2_6_CFP.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_CFP.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_CFP;



%MACRO DIVIDE_PORTFOLIO_6_size_EP (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME EP pctlpts= 30 70; /* HX ADD */
run;
...
data june ; set ccm3_june;
 ...
 if 0 < ep <= ep30 then         epport = 'EP1' ;
 else if ep30 < ep <= ep70 then epport = 'EP2' ;
 else if ep  > ep70 then        epport = 'EP3' ;
 else epport='';
end;
else positiveep=0;
...
%mend DIVIDE_PORTFOLIO_6_size_EP;

%MACRO DIVIDE_PORTFOLIO_6_SIZE_RVAR (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm_month noprint;
  ...
  var ME RVAR;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME RVAR pctlpts= 30 70 ;
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  rvar <= rvar30 then              rvarport = 'RVAR1' ;
 else if rvar30 < rvar <= rvar70 then rvarport = 'RVAR2' ;
 else if rvar  > rvar70 then          rvarport = 'RVAR3' ;
 else rvarport='';
 end;
 else positiveme = 0;
...
proc export data=vwret outfile="vwret_6_RVAR.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_RVAR.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_RVAR.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_RVAR;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_SVAR (begdate=, enddate=, table_out=);
...
proc univariate data=ccm_month noprint;
  ...
  var ME SVAR;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME SVAR pctlpts= 30 70 ;
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  0<= svar <= svar30 then              svarport = 'SVAR1' ;
 else if svar30 < svar <= svar70 then svarport = 'SVAR2' ;
 else if svar  > svar70 then          svarport = 'SVAR3' ;
 else svarport='';
 end;
 else positiveme = 0;
...
proc export data=vwret outfile="vwret_6_SVAR.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_SVAR.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_SVAR.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_SVAR;



%MACRO DIVIDE_PORTFOLIO_6_SIZE_BETA (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm_month noprint;
  ...
  var ME BEME beta;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME beta pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  beta <= beta30 then              betaport = 'BETA1' ;
 else if beta30 < beta <= beta70 then betaport = 'BETA2' ;
 else if beta  > beta70 then          betaport = 'BETA3' ;
 else betaport='';
 end;
 else positiveme = 0;
...
proc export data=vwret outfile="vwret_6_BETA.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_BETA.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_BETA.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_BETA;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_NI (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm2_june noprint;
  ...
  by date; /*at june;*/
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME BEME NI pctlpts= 30 70; /* HX ADD */
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if ni < 0 then           niport = 'NI1' ;
 else if  ni = 0 then niport = 'NI2' ;
 else if ni  > 0 then          niport = 'NI3' ;
 else niport='';
end;
else positivebeme=0;
...
proc export data=vwret outfile="vwret_6_NI.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_NI.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_NI.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_NI;


%MACRO DIVIDE_PORTFOLIO_6_SIZE_DY (begdate=, enddate=, table_out=);
/************************ Part 1: Compustat ****************************/
/* Compustat XpressFeed Variables:                                     */
/* AT      = Total Assets                                              */
/* PSTKL   = Preferred Stock Liquidating Value                         */
...
proc univariate data=ccm_month noprint;
  ...
  var ME DY;
  by date;
  output out=nyse_breaks median = SIZEMEDN pctlpre=ME DY pctlpts= 30 70 ;
run;
 ...
 * and BE (t-1) >0 and more than two years in Compustat;
 ...
 if  0< dy <= dy30 then              dyport = 'DY1' ;
 else if dy30 < dy <= dy70 then dyport = 'DY2' ;
 else if dy  > dy70 then          dyport = 'DY3' ;
 else dyport='';
 end;
 else positiveme = 0;
...
proc export data=vwret outfile="vwret_6_DY.csv"
dbms=csv replace;
...
proc export data=vwret2 outfile="vwret2_6_DY.csv"
dbms=csv replace;
...
proc export data=vwret3 outfile="vwret3_6_DY.csv"
dbms=csv replace;
...
%mend DIVIDE_PORTFOLIO_6_SIZE_DY;
