  ...
  *==============================================================================
  ...
  data chars.firmchars_v7_1_raw;
  	...
  	*==============================================================================;
  	...
  	%let info = date permno gvkey cnum ret exchcd
   ...
   za_sp
    ...
    data check_sample; set check_sample;
  	...
  	else f_rd_mve = z_rd_mve;
		/*rdm*/
		if missing(z_rdm) then f_rdm = za_rdm;
		else f_rdm = z_rdm;
		/* adm */
  	...
  	if missing(z_roa) then f_roa = za_roa;
		...
		/* roe */
		if missing(roeq) then f_roe = roe;
		else f_roe = roeq;
  	/*depr*/
